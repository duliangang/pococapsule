...
<!--
	A user defined robortic application assembly schema to
	PocoCapsule/C++ core schmea transformation style sheet.
...
<xsl:template match="/robotic-application">
...
<xsl:template match="component/controls">
  <ioc>
